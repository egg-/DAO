 ...
 */
DB.prototype.fetchOne = function (id, cb, sql, value, field, extra) {
  if (typeof id !== 'string') {
    extra = field
    field = value
    value = sql
  ...
  return this.query(id, function (err, rows, fields, query) {
    extra ?
      ...
      cb(err, rows.length === 0 ? null : rows[0][field])
  }, sql, value)
}
 ...
 */
DB.prototype.fetch = function (id, cb, sql, value, extra) {
  var self = this
  ...
  return this.query(id, function (err, rows, fields, query) {
    extra ?
      ...
      cb(err, rows.length === 0 ? null : self._dao.migrateItem(rows[0]))
  }, sql, value)
}
 ...
 */
DB.prototype.fetchAll = function (id, cb, sql, value, extra) {
  var self = this
